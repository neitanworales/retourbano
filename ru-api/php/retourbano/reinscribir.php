...
if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
    ...
    if ($correcto) {
        ...
        if (!empty($busqueda)) {
            if ($datos->actualizar($id, $nombre, $nick, $fechaNac, $edad, $sexo, $talla, $vienesDe, $alergias, $razones, $tutorNombre, $tutorTelefono, $iglesia, $email, $whatsapp, $facebook, $instagram, $aceptaPoliticas, $medicamentos, $telefono)) {
