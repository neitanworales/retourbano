...
const routes: Routes = [
  ...
  { path: 'inscripciones', component: InscripcionesComponent, canActivate: [hasRoleGuard(['super', 'admin'])] },
  { path: 'hospedaje', component: HospedajesComponent, canActivate: [hasRoleGuard(['super', 'admin', 'staff'])] },
  { path: 'asistencia', component: AsistenciaComponent, canActivate: [hasRoleGuard(['super', 'admin', 'staff'])] },
  { path: 'contabilidad', component: ContabilidadComponent, canActivate: [hasRoleGuard(['super', 'admin'])] },
  { path: 'campamentos', component: CampamentosComponent, canActivate: [hasRoleGuard(['super', 'admin'])] },
];
